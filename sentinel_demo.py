...
def render_conversational_tab():
    ...
    col1, col2, col3 = st.columns(3)
    col1.button("Remediate all via Terraform", use_container_width=True)
    col2.button("Create Jira swarm", use_container_width=True)
    col3.button("Share to Slack #sec-war-room", use_container_width=True)
